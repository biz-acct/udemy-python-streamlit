...
with col2:
    st.page_link("pages/page1.py", label="ページ1")
with col3:
    st.page_link("pages/page2.py", label="ページ2")
with col4:
    st.page_link("pages/page3.py", label="ページ3")
with col5:
